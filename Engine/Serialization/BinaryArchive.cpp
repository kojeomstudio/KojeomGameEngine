...
uint32 KBinaryArchive::ComputeChecksum() const
{
    ...
    static const uint32 CrcTable[256] =
    {
        ...
        0x3B6E20C8, 0x4C69105E, 0xD56041E4, 0xA2677172, 0x3C03E4D1, 0x4B04D447, 0xD20D85FD, 0xA50AB54B,
        ...
        0x86D3D2D4, 0xF1D4E242, 0x68DDB3F8, 0x1FDA836E, 0x81BE20CD, 0xF6B9105B, 0x6FB041E1, 0x18B77177,
        0x88086CE6, 0xFF0F5C70, 0x66060DCA, 0x11013D5C, 0x8F65A8FF, 0xF8629869, 0x616BC9D3, 0x166CF945,
    ...
    {
        uint8 index = static_cast<uint8>(crc ^ Buffer[i]);
