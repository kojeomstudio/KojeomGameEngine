...
private:
    ...
    {
        DrawDigitString(10, screenHeight - 15, std::to_string(static_cast<int>(stats.fps)), screenWidth, screenHeight);
        DrawDigitString(70, screenHeight - 15, "FPS", screenWidth, screenHeight);
        DrawDigitString(10, screenHeight - 30, std::to_string(static_cast<int>(stats.frameTimeMs * 100.0f) / 100.0f).substr(0, 5) + "ms", screenWidth, screenHeight);
        DrawDigitString(10, screenHeight - 45, "DC:" + std::to_string(drawCallCount), screenWidth, screenHeight);
        DrawDigitString(10, screenHeight - 60, "E:" + std::to_string(stats.entityCount), screenWidth, screenHeight);
        DrawDigitString(10, screenHeight - 75, "A:" + std::to_string(stats.loadedAssets), screenWidth, screenHeight);
    }
    ...
    void DrawBitmapChar(float x, float y, int charCode, int screenWidth, int screenHeight)
    {
        ...
        const uint8_t* glyph = GetCharGlyph(charCode);
    ...
    static const uint8_t* GetCharGlyph(int charCode)
    {
        static const uint8_t glyphs[38][8] = {
            {0x3C,0x42,0x42,0x42,0x42,0x42,0x42,0x3C},
            {0x08,0x18,0x28,0x08,0x08,0x08,0x08,0x3E},
            {0x3C,0x42,0x02,0x0C,0x30,0x40,0x40,0x7E},
            ...
            {0x3C,0x42,0x42,0x7E,0x42,0x42,0x42,0x42},
            ...
            {0x02,0x02,0x02,0x02,0x02,0x02,0x42,0x3C},
            ...
            {0x18,0x18,0x18,0x00,0x00,0x00,0x18,0x18},
            {0x10,0x30,0x10,0x00,0x00,0x00,0x00,0x00},
        };
