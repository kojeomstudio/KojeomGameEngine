...
|--------|------:|------:|-------------|
| Graphics | 73 | 19,875 | DirectX 11 렌더링 (Forward/Deferred, PBR, Shadow, PostProcess, IBL, SSAO, SSR, TAA, SSGI, 20 서브시스템) |
| Assets | 16 | 4,203 | 정적/스켈레탈 메시, 스켈레톤, 애니메이션, 모델 로더 (FBX/OBJ/GLTF) |
...
| Audio | 6 | 861 | XAudio2 오디오, 3D 사운드 |
| Serialization | 4 | 824 | 바이너리/JSON 아카이브 |
| Input | 3 | 655 | 키보드, 마우스, Raw Input, Action Mapping |
| Scene | 4 | 628 | Actor-Component 시스템, 씬 관리 |
| DebugUI | 2 | 241 | ImGui 디버그 오버레이 |
| Utils | 3 | 257 | Common.h, Logger.h, Math.h |
| **Total** | **147** | **31,599** | |
...
|-----------|------:|------:|-------------|
| EngineInterop | 2 | 1,114 | C++ DLL (flat C API, 107 exported functions) for C# P/Invoke |
| KojeomEditor | 14 | 3,397 | WPF 에디터 (.NET 8.0) - Viewport, Scene Hierarchy, Properties, Material Editor, Renderer Settings, Content Browser |
